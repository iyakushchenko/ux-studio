...
3e. [~] **PDP PAGE FINAL PASS hard-green** — demoted **NEEDS-REPROVE** after PO polish (full FAQ bodies + TertiaryCta soft Find out more + Accordion kit motion/muted chevrons). Structure stamp retained; Quinn MCP + Uma §0a must re-prove. Prior HARD-GREEN @ tip `c6e8931` / v0.0.28. Audit: [FE_AUDIT_PDP_PAGE_FINAL_PASS_2026-07-19.md](../projects/boots-pharmacy/audits/FE_AUDIT_PDP_PAGE_FINAL_PASS_2026-07-19.md). **Home still waits PO `+`.**
