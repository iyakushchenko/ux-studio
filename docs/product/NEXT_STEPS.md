...
6. [~] **Chat React migration** — **PO override kickoff** (2026-07-19): started while Site Pilot **not** Final Pass hard-green. Register [CHAT_MAKE_PARITY_REGISTER.md](../projects/boots-pharmacy/features/CHAT_MAKE_PARITY_REGISTER.md) · brief [CHAT_REACT.md](../projects/boots-pharmacy/features/CHAT_REACT.md) · Make child 10 · **NOT hard-green / NOT PROVEN**. PDP HARD-GREEN unchanged. **FE scaffold:** `screens/chat/*` + shared `screens/shared/SitePilotComposer.tsx` · mount gated `CHAT_REACT_MOUNT_ENABLED=false` (Make dock + `site-pilot-chat` playback until flip).
