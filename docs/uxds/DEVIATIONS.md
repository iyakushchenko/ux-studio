...
| **Status** | approved |
| **Surfaces** | Boots PDP GP promo “Find out more” (Legacy Frame104 mint pill) |
...
| **Tokens used** | `--uxds-surface-accent-soft`, `--project-brand-cta-navy`, `--project-brand-cta-navy-hover`, `--project-brand-primary-light` (+ Legacy mint `#e0fbf8` / ring `#d4fef8`) |
