# Book Step 3 — Legacy vs React design delta

**Status:** Pilot ship (2026-07-19)  
**Source of truth:** Legacy Frame child **3** (`Body2` / `ComponentAppointmentSummary`) + wire Advantage / Open Appointments patches.  
...
| Element | Legacy / wire | React | Status |
|---------|-------------|-------|--------|
...
| Explore / Calendar CTAs | Navy commerce pills | `ButtonPrimary` + `--commerce` | **match** (Calendar inert as Legacy) |
