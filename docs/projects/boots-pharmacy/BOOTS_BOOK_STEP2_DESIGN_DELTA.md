# Book Step 2 — Legacy vs React design delta

**Status:** Pilot ship (2026-07-19)  
**Source of truth:** Legacy Frame child **4** (`Body3` / `ComponentAppointmentSummary1`) + live wire calendar CSS in `globals-screens.css`.  
...
| Time bands | Morning / Afternoon / Evening | Legacy availability (15:15+) | **match** |
