...
export const BOOK_STEP3_CUSTOMER_EMAIL = "s.jenkins@example.com";
export const BOOK_STEP3_CUSTOMER_PHONE = "0345 156 654";
export const BOOK_STEP3_PAID_WITH = "Apple Pay (Visa 2569)";
