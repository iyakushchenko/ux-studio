...
/**
 * Erase-Legacy DONE (board #8): delete Book Step 1's Legacy chrome outright on
 * first mount — no restore path back to Legacy for this screen.
 */
function hideMakeChrome(page: HTMLElement): void {
  retireLegacyUnderPage(page, BOOK_STEP1_REACT_SCREEN_ID, {
    hideSelectors: HIDE_SELECTORS,
    permanent: true,
  });
}

/** True when Book Step 1 Legacy wire has been retired for the React pilot. */
