...
/** Keep Studio chrome mounts; retire every Legacy Frame child under Home. */
...
function hideMakeChrome(page: HTMLElement): void {
  retireLegacyUnderPage(page, HOME_REACT_SCREEN_ID, {
    keepClassNames: KEEP_VISIBLE,
    permanent: true,
  });
}

/** True when Home Legacy wire has been retired for the React migration. */
